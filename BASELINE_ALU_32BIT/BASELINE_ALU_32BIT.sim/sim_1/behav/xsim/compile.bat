...
REM
REM Generated by Vivado on Sat Oct 11 01:57:33 +0530 2025
...
echo "xvlog --incr --relax -prj tb_alu_top_vlog.prj"
call xvlog  --incr --relax -prj tb_alu_top_vlog.prj -log xvlog.log
